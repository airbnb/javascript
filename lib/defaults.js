...
module.exports = {
  ...
  // Hack shit to get the legacy rules from AirBnB to run....
  extends: 'lint-trap/node_modules/eslint-config-airbnb-base/legacy',
...
let version = require.main.require('eslint/package.json').version;
